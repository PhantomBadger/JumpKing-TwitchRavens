    ...
    public class JumpKingPunishmentModSettingsContext
    {
        ...
        public static Dictionary<string, string> GetDefaultSettings()
        {
            return new Dictionary<string, string>()
            {
                ...
                { MaxPunishmentIntensityKey, 15.0f.ToString(CultureInfo.InvariantCulture) },
                ...
                { MinRewardIntensityKey, 10.0f.ToString(CultureInfo.InvariantCulture) },
                { MaxRewardDurationKey, 1.0f.ToString(CultureInfo.InvariantCulture) },
                { MaxRewardIntenityKey, 100.0f.ToString(CultureInfo.InvariantCulture) },
